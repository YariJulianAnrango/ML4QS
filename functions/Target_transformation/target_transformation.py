...
def Target_classification(df):
    ...
    for j in range(len(New_weather_steps)):
        if New_weather_steps.loc[j,"temp_class"] == "Freezing" and New_weather_steps["rain"][j] == 0:
            New_weather_steps.loc[j,"combined"] = "Freezing0"
        elif New_weather_steps.loc[j,"temp_class"] == "Freezing" and New_weather_steps["rain"][j] == 1:
            New_weather_steps.loc[j,"combined"] = "Freezing1"
        elif New_weather_steps.loc[j,"temp_class"] == "Cold" and New_weather_steps["rain"][j] == 0:
            New_weather_steps.loc[j,"combined"] = "Cold0"
        elif New_weather_steps.loc[j,"temp_class"] == "Cold" and New_weather_steps["rain"][j] == 1:
            New_weather_steps.loc[j,"combined"] = "Cold1"
        elif New_weather_steps.loc[j,"temp_class"] == "Chilly" and New_weather_steps["rain"][j] == 0:
            New_weather_steps.loc[j,"combined"] = "Chilly0"
        elif New_weather_steps.loc[j,"temp_class"] == "Chilly" and New_weather_steps["rain"][j] == 1:
            New_weather_steps.loc[j,"combined"] = "Chilly1"
        elif New_weather_steps.loc[j,"temp_class"] == "Comfortable" and New_weather_steps["rain"][j] == 0:
            New_weather_steps.loc[j,"combined"] = "Comfortable0"
        elif New_weather_steps.loc[j,"temp_class"] == "Comfortable" and New_weather_steps["rain"][j] == 1:
            New_weather_steps.loc[j,"combined"] = "Comfortable1"
        elif New_weather_steps.loc[j,"temp_class"] == "Warm" and New_weather_steps["rain"][j] == 0:
            New_weather_steps.loc[j,"combined"] = "Warm0"
        elif New_weather_steps.loc[j,"temp_class"] == "Warm" and New_weather_steps["rain"][j] == 1:
            New_weather_steps.loc[j,"combined"] = "Warm1"
        elif New_weather_steps.loc[j,"temp_class"] == "Hot" and New_weather_steps["rain"][j] == 0:
            New_weather_steps.loc[j,"combined"] = "Hot0"
        elif New_weather_steps.loc[j,"temp_class"] == "Hot" and New_weather_steps["rain"][j] == 1:
    ...
    New_weather_steps = New_weather_steps.drop(columns=['temp_celsius', 'rain', 'temp_class'])
